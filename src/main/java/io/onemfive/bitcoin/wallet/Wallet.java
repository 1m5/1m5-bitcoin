...
import io.onemfive.bitcoin.blockchain.TransactionOutput;
...
/**
 * Stores keys using them to send and receive {@link io.onemfive.bitcoin.Satoshi}
 * encapsulated in a {@link io.onemfive.bitcoin.blockchain.Transaction}.
 *
 * @author objectorange
 */
public class Wallet {
